...
const Register = () => {
    ...
    return (
        <div className="hero min-h-screen bg-base-200 bg-gradient-to-r from-cyan-50 to-blue-50">

            <div className="hero-content flex-col lg:flex-row mt-10">

                <div className="card  bg-opacity-20 shadow-xl lg:max-w-[500px] max-w-[280px] w-full">
